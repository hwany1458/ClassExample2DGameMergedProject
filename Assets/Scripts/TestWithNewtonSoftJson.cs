...
public class TestWithNewtonSoftJson : MonoBehaviour
{
    ...
    public void WriteToJsonFile()
    {
        ...
        string savingJsonFileName = Path.Combine(Application.dataPath, "ObjectToJsonNewtonSoft.json");
    ...
    {
        string jsonFileName = Path.Combine(Application.dataPath, "ObjectToJsonNewtonSoft.json");
