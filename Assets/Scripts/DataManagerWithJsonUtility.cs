...
public class DataManagerWithJsonUtility : MonoBehaviour
{
    ...
    public void WriteToJson()
    {
        ...
        string savingFileName = Path.Combine(Application.dataPath, "playerData.json");
    ...
    {
        // 현재 실행중인 유니티 프로젝트 경로에 저장 : Application.dataPath 
        string readFileName = Path.Combine(Application.dataPath, "playerData.json");
